...
class thumbnail
{
	...
	function thumbnail($imgfile)
	{
		...
		@$this->img["altura"] = imagesy($this->img["src"]);
	...
	{
		@$this->img["dim_thumb"] = $size;

		if ($this->img["ancho"] < $this->img["altura"])
		{
			@$this->img["x"] = 0;
			@$this->img["dim"] = $this->img["ancho"];

		}
		else
		{
			@$this->img["x"] = ($this->img["ancho"]-$this->img["altura"])/2;
			@$this->img["dim"] = $this->img["altura"];
		}
	}
	...
	function show()
	{
		...
		$this->img["des"] = ImageCreateTrueColor($this->img["dim_thumb"],$this->img["dim_thumb"]);
    		@imagecopyresized ($this->img["des"], $this->img["src"], 0, 0, $this->img["x"], 0, $this->img["dim_thumb"], $this->img["dim_thumb"], $this->img["dim"], $this->img["dim"]);
